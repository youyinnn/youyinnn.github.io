...
贴一个Electron的github项目地址：https://github.com/electron/electron ，里面有安装说明。
...
`package.json`的格式和Node完全一致，而且被main字段声明的脚本文件是你的应用的启动脚本，它运行在主进程上。你应用里的`package.json`看起来应该：
``` json
{
  "name"    : "your-app",
  "version" : "0.1.0",
