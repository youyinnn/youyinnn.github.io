...
$$ASL = (1 * 1 / n ) + (2 * 1 / n) + \dots + (n * 1 / n) = [1 / n * ( n * \dfrac{n + 1}{2})] = \dfrac{n + 1}{2}$$
...
根据这个，求出next数组，数组中每个值代表**部分匹配**，一下摘自[刘毅](https://subetter.com/articles/2018/04/how-to-understand-kmp.html)中的手算过程，稍作修改：
