/*! highlight.js v9.12.0 | BSD3 License | git.io/hljslicense */ ! function (e) {
    ...
    function a(n, i) {
      if (!n.compiled) {
        if (n.compiled = !0, n.k = n.k || n.bK, n.k) {
          ...
          "string" == typeof n.k ? o("keyword", n.k) : k(n.k).forEach(function (e) {
            o(e, n.k[e])
          }), n.k = s
        }
  ...
  function d(e, r, n, i) {
    ...
    function f() {
      var e, r, a, n;
      if (!N.k) return t(M);
      for (n = "", r = 0, N.lR.lastIndex = 0, a = N.lR.exec(M); a;) n += t(M.substring(r, a.index)), e = l(N, a), e ? (E += e[1], n += p(e[0], t(a[0]))) : n += t(a[0]), r = N.lR.lastIndex, a = N.lR.exec(M);
      return n + t(M.substr(r))
    }

    function m() {
      var e = "string" == typeof N.sL;
      if (e && !x[N.sL]) return t(M);
      var r = e ? d(N.sL, M, !0, k[N.sL]) : b(M, N.sL.length ? N.sL : void 0);
      return N.r > 0 && (E += r.r), e && (k[N.sL] = r.top), p(r.language, r.value, !1, !0)
    }
  ...
  function p(e) {
    return S.tabReplace || S.useBR ? e.replace(B, function (e, t) {
  ...
  function m(e) {
    var t, r, a, s, l, u = i(e);
    n(u) || (S.useBR ? (t = document.createElementNS("http://www.w3.org/1999/xhtml", "div"), t.innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n")) : t = e, l = t.textContent, a = u ? d(u, l, !0) : b(l), r = o(t), r.length && (s = document.createElementNS("http://www.w3.org/1999/xhtml", "div"), s.innerHTML = a.value, a.value = c(r, o(s), l)), a.value = p(a.value), e.innerHTML = a.value, e.className = f(e.className, u, a.language), e.result = {
      language: a.language,
      re: a.r
  ...
  return e.highlight = d, e.highlightAuto = b, e.fixMarkup = p, e.highlightBlock = m, e.configure = g, e.initHighlighting = _, e.initHighlightingOnLoad = h, e.registerLanguage = y, e.listLanguages = v, e.getLanguage = w, e.inherit = s, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*", e.NR = "\\b\\d+(\\.\\d+)?", e.CNR = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BNR = "\\b(0b[01]+)", e.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", e.BE = {
    ...
    return f.c = [e.C("comment", ""), g, m], m.c = _, u.c = _, b.c = [u], {
      aliases: ["clj"],
      i: /\S/,
      c: [f, o, d, b, c, p, u, s, l]
    }
    ...
    n.c = [o, s, r, e.ASM, e.QSM, e.CNM, e.CBCM], i.c = [c, s, a, e.ASM, e.QSM, e.CNM, e.inherit(e.CBCM, {
      i: /\n/
    })];
    var l = {
        v: [o, s, r, e.ASM, e.QSM]
