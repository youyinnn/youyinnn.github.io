    ...
    return t.firstUpperCase = t.ucfirst = a, t.urls = {
      ...
      return l.emoji = function (e) {
        ...
        for (let ss = ii.length - 1; ss >= 0; ss--) {
          if (ii[ss].level < ii[ii.length - 1].level) {
            pp = ii[ss].text
            break
          }
        }
